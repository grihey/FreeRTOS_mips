...
/*-----------------------------------------------------------
 * Implementation of functions defined in portable.h for the MIPSfpga port.
  *----------------------------------------------------------*/
#include <stdlib.h>
...
//#define TIMER_PERIOD (( configPERIPHERAL_CLOCK_HZ / configTICK_RATE_HZ ) - 1UL)
#define TIMER_PERIOD (( configPERIPHERAL_CLOCK_HZ ) - 1UL)

//volatile int *IO_LEDR = (int*)0xbf800000;

#define _CP0_BIS_CAUSE(set)  mips_biscr(set)
...
#define portINITIAL_SR ( 0x00000401 )
//  #define portINITIAL_SR ( 0x00000001 )
...
/* Idont know what it is, just copy and paste*/
