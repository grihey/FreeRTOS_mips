...
#include <mips/cpu.h>   // MIPSfpga

#define _CP0_GET_STATUS()  mips_getsr()  // MIPSfpga
#define _CP0_SET_STATUS(v) mips_setsr(v) // MIPSfpga
#define _CP0_GET_CAUSE()  mips_getcr()   // MIPSfpga
#define _CP0_SET_CAUSE(v) mips_setsr(v)  // MIPSfpga
#define _clz(v) mips_clz(v)              // MIPSfpga
